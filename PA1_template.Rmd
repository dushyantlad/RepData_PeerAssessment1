...
```
 ...
 Mean=`r stotal_mean` and median=`r stotal_median` for total number of steps taken per day.
...
Answere: 835 (maximum avg steps=206.1698)
...
Mean=`r stotal_mean` and median=`r stotal_median` for total number of steps taken per day for the case where all the NA values are replaced.
